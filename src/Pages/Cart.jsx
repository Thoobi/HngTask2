    ...
    return(
        <div>
            ...
            <div className="mt-[30px] max-lg:mt-[20px] font-inika">
                ...
                <div className="flex flex-row justify-start items-center w-[90%] mx-auto my-0 max-lg:my-7">
                    <Link to="/">
                ...
                <div className="flex flex-row justify-between w-[90%]  mx-auto my-[20px]">
                    ...
                    <div className="w-[50%] flex flex-col justify-between">
                        <div className="w-full flex flex-col justify-between items-start">
                            ...
                            <div className="flex flex-row justify-between w-[20%] max-lg:w-[60%] max-md:w-[80%] max-lg:my-1 items-center mb-2">
                                <AiOutlineMinusSquare className="max-lg:size-[30px] size-[40px] cursor-pointer" />
                                <span className="max-lg:text-2xl text-2xl font-semibold">2</span>
                                <AiOutlinePlusSquare className=" max-lg:size-[30px] size-[20px] cursor-pointer" />
                                <AiOutlineDelete className=" max-lg:size-[25px] size-[20px] cursor-pointer" />
                            </div>
                            ...
                            <div className="flex flex-row justify-between items-center w-[50%] gap-2 mt-8 max-md:mt-5 max-lg:w-[80%] max-md:w-full max-md:flex-wrap max-md:flex-row max-md:gap-2">
                            ...
                            <div className="w-[45%] mt-10">
                                <div className="flex flex-col">
                                    ...
                                    <ul className="flex flex-col justify-between">
                                        ...
                                        <li>Store for up to 1 week in an air tight container in a fridge or freezer</li>
                                    </ul>
                                </div>

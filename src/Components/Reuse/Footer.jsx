...
const Footer = () =>{
    return(
        <div className="w-full max-lg:pt-1 pt-[15px] bg-[#FFE1DB] max-lg:bg-white font-inika flex flex-row justify-center items-center">
            ...
            <div className="w-[90%] max-lg:w-full mx-auto my-0 bg-[#FFE1DB] max-lg:bg-white flex flex-row justify-between items-start max-lg:items-center max-lg:justify-between max-lg:flex-col gap-3">
                ...
                <div className='max-lg:w-full max-lg:justify-center max-lg:items-center flex flex-col justify-between w-[20%] max-lg:px-4 max-lg:py-2 max-lg:bg-[#FFE1DB]'>
                    ...
                    <div className='w-[85%] flex flex-col justify-between items-start'>
                        <div className='max-lg:w-[38%] max-md:w-[75%] max-lg:mx-auto max-lg:justify-between flex justify-start flex-row'>
                            <AiOutlineMail className='align-bottom  size-[24px]' />
                            <Link className='underline text-base'>morethanwafels@gmail.com</Link>
                        </div>
                        
                        <div className='max-lg:w-[20%] max-md:w-[45%] max-lg:mx-auto max-lg:justify-between flex justify-start flex-row font-medium max-lg:mt-2'>
                            <MdPhone className='scale-y-[-1px] align-middle size-[24px]' /><p className='text-[17px]'>+2348176754434</p>
                        </div>
                    </div>
                </div>
